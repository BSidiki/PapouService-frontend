...
export class AdminPubsComponent implements OnInit {
  ...
  onSubmit() {
    ...
    const request = this.isEditing
      ? this.http.put(`http://192.168.57.230:8080/pubs/${this.editId}`, formData)
      : this.http.post('http://192.168.57.230:8080/pubs', formData);
  ...
  deletePub(id: number) {
    ...
    this.http.delete(`http://192.168.57.230:8080/pubs/${id}`).subscribe({
      next: () => this.loadPubs(),
